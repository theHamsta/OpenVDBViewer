...
/// @class Plane
/// @brief Plane class hevaily based on Jon Maceys NGL Camera class (http://nccastaff.bmth.ac.uk/jmacey/GraphicsLib).
/// Modified to rely on the OpenVDB math library and remove some features not needed. Used only within the Camera class for
/// the frustrum.
class Plane
{
	public:
